...
namespace LMS.Migrations
{
    ...
    [Migration("20260527182020_AddOriginalFileName")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LMS.Models.Grade", b =>
                {
                    b.HasOne("LMS.Models.ApplicationUser", "GradedBy")
                        .WithMany()
                        .HasForeignKey("GradedById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("LMS.Models.Submission", "Submission")
                        .WithOne("Grade")
                        .HasForeignKey("LMS.Models.Grade", "SubmissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
